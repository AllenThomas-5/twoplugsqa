...
public class TP_LoginTest extends BaseTest {
	
	/* Test case test the the following Tests
	 * TP-033
	 * TP-034
	 * TP-041
	...
	public void loginValidUsername(String username, String password) throws InterruptedException, IOException {
		...
		loginTest = extent.createTest(baseBrowser + " Verify Login Page").assignAuthor("Allen").assignCategory("Functional Test");
